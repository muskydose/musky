...
export function generateWhatsAppOrderMessage(
  ...
  const vars: Record<string, string | number> = {
    ...
    quantity: quantity,
    unit: product.packUnit || 'Unit',
    pack_unit: product.packUnit || 'Unit',
    pricing_unit: product.pricingUnit || product.packUnit || 'Unit',
    selling_unit: product.sellingUnit || 'Pack',
    pack_quantity: product.packQuantity || 1,
    weight: product.quantityOrWeight || (product.packQuantity && product.packUnit ? `${product.packQuantity} ${product.packUnit}` : 'Standard Pack'),
...
export function getWhatsAppPreviewMessage(
  ...
  const sampleVars: Record<string, string | number> = {
    brand_name: brandName,
    business_name: brandName,
    product_name: 'Sojat Pure Ultra-Fine Sifted Henna Powder',
    ...
    subtotal: 498,
    total: 498,
    items: '1. *Sojat Pure Ultra-Fine Sifted Henna Powder* (250g Pack)\n   Qty: 2 x ₹249 = ₹498',
