...
export function mapRowToProduct(row: any): Product {
  ...
  return {
    ...
    pricingUnit: row.pricing_unit || row.pricingUnit || undefined,
    wholesaleUnit: row.wholesale_unit || row.wholesaleUnit || undefined,
    minWholesaleQuantity: typeof row.min_wholesale_quantity === 'number' ? row.min_wholesale_quantity : typeof row.minWholesaleQuantity === 'number' ? row.minWholesaleQuantity : undefined,
    maxWholesaleQuantity: typeof row.max_wholesale_quantity === 'number' ? row.max_wholesale_quantity : typeof row.maxWholesaleQuantity === 'number' ? row.maxWholesaleQuantity : undefined,
    conversionRule: row.conversion_rule || row.conversionRule || undefined,
...
export async function saveProduct(product: Partial<Product>): Promise<Product> {
  ...
  const fullProduct: Product = {
    ...
    lifecycleStatus: product.lifecycleStatus || 'SAVED',
    ...
    maxWholesaleQuantity: product.maxWholesaleQuantity,
    conversionRule: product.conversionRule,
