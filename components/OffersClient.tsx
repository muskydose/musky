    ...
    <div className="space-y-12">
      ...
      <div className="bg-gradient-to-br from-[#0f2d22] via-[#1b4332] to-[#0f2d22] text-white rounded-3xl p-6 sm:p-10 border border-[#c5a059]/40 shadow-2xl relative overflow-hidden text-center sm:text-left">
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#c5a059] text-[#0f2d22] font-bold text-xs uppercase tracking-wider">
            ...
            {cms.offersHeroBadge || 'Exclusive Offers'}
          </span>

          <h1 className="font-momo-display font-normal text-3xl sm:text-5xl text-white leading-tight">
            {cms.offersHeroTitle || 'Special Botanical Deals & Festival Offers'}
          </h1>

          <p className="text-stone-200 text-sm sm:text-base leading-relaxed max-w-2xl">
            {cms.offersHeroSubtitle || 'Discover verified coupons, seasonal savings, and bulk discounts on authentic Sojat henna, pure indigo, and natural herbs.'}
          </p>
        </div>
      </div>
      ...
      {campaigns.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center border border-stone-200 shadow-xs space-y-4 max-w-xl mx-auto">
          ...
          <h2 className="font-momo-display font-normal text-2xl text-[#0f2d22]">
            {cms.offersEmptyTitle || 'No Active Public Coupons Right Now'}
          </h2>
          <p className="text-sm text-stone-600">
            {cms.offersEmptyDescription || 'Check back soon for upcoming festive deals, or explore our standard factory-direct pricing across the entire catalog.'}
          </p>
          <Link
            href="/products"
                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#1b4332] hover:bg-[#0f2d22] text-white rounded-xl text-xs font-medium flex items-center gap-1 shadow-xs transition-all shrink-0 cursor-pointer"
                          >
